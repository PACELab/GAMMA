...
local function compose_post()
  ...
  local method = "POST"
  local path = "http://10.98.241.155:8080/wrk2-api/post/compose"
  local headers = {}
  local body
...
local function read_user_timeline()
  ...
  local headers = {}
  headers["Content-Type"] = "application/x-www-form-urlencoded"
  local path = "http://10.98.241.155:8080/wrk2-api/user-timeline/read?" .. args
...
local function read_home_timeline()
    ...
    local headers = {}
    headers["Content-Type"] = "application/x-www-form-urlencoded"
    local path = "http://10.98.241.155:8080/wrk2-api/home-timeline/read?" .. args
    return wrk.format(method, path, headers, nil)
  end
